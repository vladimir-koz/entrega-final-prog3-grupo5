    ...
    <form className="content-section editor-form" onSubmit={onSubmit}>
      ...
      <div className="form-grid two-columns">
        ...
        <label>
          Grupo muscular
          <input
            value={form.grupoMuscularEtiqueta}
            onChange={(event) => updateField("grupoMuscularEtiqueta", event.target.value)}
          />
        </label>
        <label>
          ...
          <input
            ...
            onChange={(event) => updateField("tiempoEstimado", event.target.value)}
          />
        </label>
      </div>
      <label>
      ...
      <ExerciseLineTable
        ...
        weightLabel="Peso objetivo"
        addLabel="Ejercicio"
      />
      <div className="form-actions">
        <span />
        <button className="primary-button">Guardar rutina</button>
      </div>
    </form>
  );
}
